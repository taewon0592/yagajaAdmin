...
public class ReservationList extends HttpServlet 
{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
		...
		List<ReservationDTO> lists = dao.selectPaging(param);
		
		//페이지 처리를 위한 문자열 생성  /reservation/reser_list
		String pagingImg = 
				PagingUtil.pagingImgServlet(totalRecordCount, pageSize, blockPage, nowPage, "../Reservation/ReservationList?"+addQueryString);
		...
		RequestDispatcher dis = req.getRequestDispatcher("/reservation/reser_list.jsp");
