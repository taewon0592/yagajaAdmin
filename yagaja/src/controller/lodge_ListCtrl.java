...
public class lodge_ListCtrl extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<LodgeDTO> lists = dao.selectpaging(param);
		...
		//뷰호출
		RequestDispatcher dis = req.getRequestDispatcher("/lodge/lodge_list.jsp");
