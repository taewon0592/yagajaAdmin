...
public class HotdealEndList extends HttpServlet{
	...
	int totalRecordCount = dao.endListgetTotalRecordCount(param);
	...
	*/
	...
	List<HotdealDTO> lists = dao.endListselectPaging(param);
	...
	// 뷰호출
	RequestDispatcher dis = req.getRequestDispatcher("/hotdeal/hotdeal_End_list.jsp");
