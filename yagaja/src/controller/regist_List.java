...
public class regist_List extends HttpServlet{
	...
	*/
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		*/
		...
		List<SurroundDTO> lists = dao.selectPaging(param);
		...
		String pagingImg = PagingUtil.pagingImgServlet(
			...
			blockPage, nowPage, 
			"../lodge/registList?"+addQueryString);
		...
		req.getRequestDispatcher("../lodge/registList.jsp");
