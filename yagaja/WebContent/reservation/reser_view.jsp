...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">예약 내역 상세보기</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
				...
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="table-responsive">
								<table width="100%"
									...
									style="text-align: center;">
										...
										<tr>
											<td style="font-weight: bold">예약일자</td>
											<td colspan="3"> ${dto.reser_date }</td>											
										</tr>
										<tr>
							...
							<button type="button" class="btn btn-warning" onclick="location.href='../Reservation/ReservationList?nowPage=${param.nowPage}';">
