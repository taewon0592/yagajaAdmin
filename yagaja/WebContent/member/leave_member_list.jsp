...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">탈퇴 회원 목록보기</div>
						<!-- /.panel-heading -->
	...
	<div class="input-group" style="padding-left:1px;" >
		<select name="searchColumn" class="form-control">
			...
			<option value="leave_reason"> 닉네임 </option> 
			<option value="leave_reason2"> 이메일 </option> 
		</select>
	</div>	
	<div class="input-group" style="padding-left:1px;">
											...
											<c:choose>
												...
												<c:otherwise>
													...
													<c:forEach items="${lists }" var="row" varStatus="loop">
														<tr>
															<td><input type="checkbox" class="inputchk" name="checkDel"
																value="${row.member_no }" /></td>
				...
				<div class="row" style="text-align: center;">
					<p>
						<!-- <button type="submit" class="btn btn-danger"
							onclick="return sendForm();">회원삭제</button> -->
