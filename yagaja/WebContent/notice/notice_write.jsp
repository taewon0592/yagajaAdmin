                        	...
                        	<form action="../Notice/NoticeWrite" name="writeFrm" method="post" onsubmit="return isValidate(this);" >
	                        	<table class="table table-striped table-bordered table-hover center" style=" width:100%; ">
		                        	...
		                        	<tr class="odd gradeX">
		                        		...
		                        		<td>
											<input type="text" style="width:300px; text-align:left;" name="notice_title"  />
		                        		</td>
		                        	</tr>
		                        	...
		                        	<tr class="odd gradeX">
		                        		...
		                        		<td>
											<input type="text" style="width:300px; text-align:left;" name="notice_name"  />
		                        		</td>
		                        	</tr>
		                        	...
		                        	<tr class="odd gradeX">
		                        		...
		                        		<td>
		                        			<textarea name="notice_contents" id="smarteditor" cols="70" rows="10" placeholder="내용을 입력해주세요"></textarea>
		                        		</td>
		                        	</tr>
